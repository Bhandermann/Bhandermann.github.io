...
/** @type {string} */
const CACHE_VERSION = '1753994763|175748076313';
/** @type {string} */
const CACHE_PREFIX = 'SpaceAce-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'SpaceAce.offline.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["SpaceAce.offline.html","SpaceAce.offline.js","SpaceAce.offline.offline.html","SpaceAce.offline.icon.png","SpaceAce.offline.apple-touch-icon.png","SpaceAce.offline.audio.worklet.js","SpaceAce.offline.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["SpaceAce.offline.wasm","SpaceAce.offline.pck","SpaceAce.offline.side.wasm"];
